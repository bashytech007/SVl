  ...
  return (
    <div className="mx-auto mt-4 ">
     ...
     <div className="md:px-28 px-6 flex gap-4 justify-around items-center mb-4 ">
        <div className="px-6">
        <h3 className="md:text-xl font-semibold mb-2">Accounting and Finance</h3>
      ...
      <div className="md:px-28 px-6 flex justify-around gap-4 items-center mb-4">
        ...
        <div className="px-10">
        <h3 className="md:text-xl font-semibold -mb-12 ">Governance, Risk Management & Compliance (GRC)</h3>
