export const Contact = () => {
  return (
    <section className="bg-image text-white bg-gradient-to-r min-h-80 from-[#541B9C80] via-[#541B9C80] to-[#FB060B40] max-w-full flex flex-col items-center mt-4 space-x-1 justify-center">
