...
//       <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 px-10 md:px-28 py-10">
...
export const Footer = () => {
  return (
    <div className="bg-[#000] ">  
      <footer className="max-w-7xl mx-auto min-h-96 grid grid-cols-1 md:grid-cols-3 gap-8 px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="space-y-4">
          ...
          <div className="text-white">
            ...
            <p className="text-sm leading-relaxed">
              life-long learning and self-improvement; embracing change as 
              the only way to remain on top of current challenges and be 
              prepared for emerging business issues. Our logo is a reflection 
              of this philosophy.
            </p>
          </div>
        </div>
        ...
        <div className="text-white md:ml-28">
          <h3 className="font-semibold text-lg mb-4">QUICK LINKS</h3>
          <nav className="space-y-3">
            <a href="/" className="block text-sm hover:text-gray-300 transition-colors">
              Home
            </a>
            <a href="/about" className="block text-sm hover:text-gray-300 transition-colors">
              About us
            </a>
            <a href="/services" className="block text-sm hover:text-gray-300 transition-colors">
              Services
            </a>
            <a href="/contact" className="block text-sm hover:text-gray-300 transition-colors">
              Contact us
            </a>
          </nav>
        </div>
        ...
        <div className="text-white ">
          ...
          <address className="text-sm not-italic leading-relaxed mb-4">
            Garki Mall (Suite C004) Opposite Garki<br />
            International Market Garki 2, Abuja. FCT.<br />
            Nigeria
          </address>
          <div className="space-y-4">
            <p className="text-sm">
